...
I have attached images inside assets/pictures from this app to show the app's manifest, service workers and indexdb. To run this app, go to server/server.js, then open an integrated terminal and type node server.js. After the app is running on port 3000 go to your browser and open localhost:3000
